        ...
        return <>
            <div className="modal-content">
                ...
                <form id="account-form">
                    ...
                    <div className="input-group" style={{width:'100%'}}>
                        <input type="password" id="password" className="input-field" placeholder="" value={staff.password} onChange={handleInputChange} style={{marginBottom:'10px'}}/>
                        <label htmlFor="password" className="input-label">Mật khẩu</label>
                        <span className="validation">{errorStaff.password}</span>
                    </div>
                    ...
                    <div className="form-actions">
                        <button type="button" className="btn btn-save" onClick={handleAddStaff}
